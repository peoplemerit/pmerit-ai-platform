...
-- Phase 1: Database Implementation for Employee Management System
-- =================================================================
...
-- Insert initial super admin user (update with your actual details)
INSERT INTO users (
    email, 
    name, 
    password_hash, 
...
-- Grant appropriate permissions (adjust based on your container user)
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO pmerit_user;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO pmerit_user;
GRANT EXECUTE ON ALL FUNCTIONS IN SCHEMA public TO pmerit_user;

-- =================================================================
-- Migration Complete!
-- 
-- Next Steps:
-- 1. Run this script against your PostgreSQL database (port 15432)
-- 2. Update the super admin password hash with actual bcrypt hash
-- 3. Verify all tables and indices are created properly
-- 4. Test with sample data
-- =================================================================

-- Verification queries (run after migration)
-- SELECT COUNT(*) FROM users; -- Should return 1 (super admin)
-- SELECT COUNT(*) FROM employee_invitations; -- Should return 0
-- SELECT * FROM active_employees; -- Should show super admin
-- SELECT * FROM pending_invitations; -- Should be empty
